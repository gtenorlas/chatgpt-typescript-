      ...
      "content":{
        ...
        "properties": {
          ...
          "hiringCost": {
            ...
            "items": {
              "type": "number",
              "description": "hiring cost [min cost in USD, max cost in USD] (find cost amount as if the user is hiring someone from Upwork or fiverr for a specific time and fields specific to prompt's context) price must be in USD"
            }
          },
          "DIYCost": {
            "type": "array",
            "items": {
              "type": "number",
              "description": "DIY (Do it yourself) cost [min cost in USD, max cost in USD] (find the cost amount as if the user will be using the platform not limited to cohere, jasper, speechify, elevenlabs, descript, canva, nas.io, mighty networks, thinkific). Price must be specific to prompt's context and in USD. No 0 allowed, must have value for both min and max cost"
            }
          }
        }
      }
